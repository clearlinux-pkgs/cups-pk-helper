...
License  : GPL-2.0
Requires: cups-pk-helper-bin
Requires: cups-pk-helper-data
Requires: cups-pk-helper-locales
...
%package bin
Summary: bin components for the cups-pk-helper package.
Group: Binaries
Requires: cups-pk-helper-data

%description bin
bin components for the cups-pk-helper package.
...
export LANG=C
export SOURCE_DATE_EPOCH=1508429090
